...
https://medium.com/ineeza/openzepplin-crowdsale%E3%81%BE%E3%81%A8%E3%82%81-fe41808ef159

npm install -g ganache-cli

purchaser = web3.eth.accounts[2]
E20Z2TokenCrowdsale.deployed().then(inst => { crowdsale = inst })
crowdsale.token().then(addr => { tokenAddress = addr } )
tokenAddress
e20Z2TokenInstance = E20Z2Token.at(tokenAddress)
e20Z2TokenInstance.addMinter(crowdsale.address)
e20Z2TokenInstance.balanceOf(purchaser).then(balance => balance.toString(10))